...
export const StockMarketTrackerChart = () => {
  ...
  return (
    <Card className="flex w-full max-w-[480px] flex-col gap-6 p-5 shadow-none md:p-6 bg-card text-card-foreground border-white/10 rounded-2xl mx-auto my-8">
      <CardHeader className="flex flex-col items-start gap-4 p-0 md:flex-row md:items-center md:justify-between md:gap-0">
        ...
        <Select value={selectedCompany} onValueChange={setSelectedCompany}>
          <SelectTrigger className="w-full md:w-[150px] h-8 bg-black/40 border-white/10 rounded-full text-xs">
      ...
      <CardContent className="flex flex-col gap-4 p-0">
        <div className="group flex w-full -space-x-[1.5px] divide-x divide-white/10 overflow-hidden rounded-lg border border-white/10">
          {periods.map((period) => (
            <button
              ...
              className="relative flex h-8 flex-1 items-center justify-center bg-transparent text-sm font-semibold tracking-[-0.006em] text-muted-foreground outline-none first:rounded-l-lg last:rounded-r-lg hover:bg-white/5 data-[active=true]:bg-white/10 data-[active=true]:text-white transition-colors"
            >
              {period.label}
            </button>
          ))}
        ...
        <div className="flex flex-col gap-1">
          <div className="flex items-baseline gap-3">
            ...
            <span className="inline-flex h-6 items-center justify-center gap-1.5 rounded-md bg-emerald-500/10 px-2 text-xs font-medium tracking-[-0.006em] whitespace-nowrap text-emerald-500">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="1em"
                height="1em"
        ...
        <ChartContainer
          config={chartConfig}
          className="aspect-auto h-[225px] w-full mt-4"
        >
        ...
        <div className="group flex w-full -space-x-[1.5px] divide-x divide-white/10 overflow-hidden rounded-lg border border-white/10 mt-2">
          <button className="relative flex h-8 flex-1 items-center justify-center bg-transparent text-sm font-semibold tracking-[-0.006em] outline-none first:rounded-l-lg last:rounded-r-lg hover:bg-white/5">
